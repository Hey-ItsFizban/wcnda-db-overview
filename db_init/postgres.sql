...
GRANT ALL PRIVILEGES ON DATABASE emedgene_v6_demo TO root;


-- PostgreSQL script with a JSON type for the JSON content.
...
-- Note: The mock data provided will be inserted here with the JSON appropriately formatted.
